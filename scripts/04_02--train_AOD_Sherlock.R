...
txt_progress_file <- "./output/aod_xgb_progress.txt"
...
mod_data <- readRDS("./data/aod_training.rds") 
...
saveRDS(bayes_opt_params, "./output/aod_bayes_opt_params.rds")
xgb.save(mod_gb_final, "./output/aod_mod.xgb")
