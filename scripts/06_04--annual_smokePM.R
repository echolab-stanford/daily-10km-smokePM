...
library(sf)
smokePM_preds <- readRDS(paste0(data_path, "/../output/smokePM_predictions_2006_2020.rds")) %>% 
...
# small minuatures of annual smoke PM
right_join(grid_10km,
  ...
  ggsave("./figures/figure4/figure4_annual_smokePM_small_multiples.png", ., 
         width = 15, height = 7)
