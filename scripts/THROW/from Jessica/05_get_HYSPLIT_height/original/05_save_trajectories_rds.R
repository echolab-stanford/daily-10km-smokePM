...
path_traj <- paste0(path_dropbox, "hms_hysplit/trajectories/")
...
mapply(saveRDS, lapply(tmp_dirs, trajectory_read), paste0(path_rds, traj_names, ".rds"))
...
# CHANGE LATER
saveRDS(rds_list, paste0(path_dropbox, "hms_hysplit/trajectories/trajectories_CA_2020.rds"))
