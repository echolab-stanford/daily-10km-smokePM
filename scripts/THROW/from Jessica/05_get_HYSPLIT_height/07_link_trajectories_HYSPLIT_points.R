...
dat_traj <- readRDS(paste0(path_dropbox, "hms_hysplit/trajectories/trajectories_72hr_CA_2020.rds")) %>% 
  bind_rows() %>% 
  select(-receptor) %>% 
...
saveRDS(dat_linked, paste0(path_dropbox, "hms_hysplit/trajectories/trajectories_72hr_CA_2020_linked.rds"))
