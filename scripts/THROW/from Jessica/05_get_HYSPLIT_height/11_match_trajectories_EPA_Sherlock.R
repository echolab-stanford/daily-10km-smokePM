...
dat_traj <- readRDS(paste0(scratch, "/matching/trajectories_72hr_CA_2020_overlap_48hr.rds"))

# Read in EPA station-days
dat_epa <- readRDS(paste0(scratch, "/matching/dat_epa.rds")) %>% 
...
# Save matched data
saveRDS(dat_matched, paste0(scratch, "/matching/results/trajectories_72hr_CA_2020_overlap_48hr_EPA_100km.rds"))
