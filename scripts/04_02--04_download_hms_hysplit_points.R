...
for (y in years) {
  ...
  for (f in files) {
    dates_20051226.20100531 = c(dates_20051226.20100531, parse_number(f))
...
dates_20051226.20100531 = as.character(dates_20051226.20100531)
saveRDS(dates_20051226.20100531, paste0(path_dropbox, "hms_hysplit/hysplit_dates_20051226-20100531.rds"))
...
saveRDS(dates_text, paste0(path_dropbox, "hms_hysplit/hysplit_dates_missing_archive_text.rds"))
...
saveRDS(dates_gis, paste0(path_dropbox, "hms_hysplit/hysplit_dates_missing_archive_gis.rds"))
...
dates_text = as.character(dates_text)
saveRDS(dates_text, paste0(path_dropbox, "hms_hysplit/hysplit_dates_missing_backup_text.rds"))
...
dates_gis = as.character(unique(dates_gis))
saveRDS(dates_gis, paste0(path_dropbox, "hms_hysplit/hysplit_dates_missing_backup_gis.rds"))
...
saveRDS(dates_not_online, paste0(path_dropbox, "hms_hysplit/hysplit_dates_not_online.rds"))
