...
dat_epa_traj <- readRDS(paste0(path_dropbox, "hms_hysplit/trajectories/trajectories_EPA_CA_2020_aggregated.rds"))
...
# Save merged file
saveRDS(dat_merged, paste0(path_dropbox, "hms_hysplit/trajectories/trajectories_EPA_smoke_AOT_CA_2020.rds"))
