...
dat_traj <- readRDS(paste0(scratch, "/matching/trajectories_CA_2020_linked.rds")) %>% 
...
# Save matched data
saveRDS(dat_matched, paste0(scratch, "/matching/results/trajectories_EPA_CA_2020_matched.rds"))
