...
#-------------------------------------------------------------------------------
# Make a Table for HMS Missing Dates
# Written by Jessica
...
# Fire points
fire_dates_not_online = readRDS(paste0(path_dropbox, "fire/fire_dates_not_online.rds"))
fire_dates_empty_data = readRDS(paste0(path_dropbox, "fire/fire_dates_empty_data.rds"))
fire_dates_clusters_too_small = readRDS(paste0(path_dropbox, "fire/fire_dates_clusters_too_small.rds"))

# HYSPLIT points
hysplit_dates_without_start_duration = seq.Date(ymd(start_date), ymd("20060418"), by = "day")
hysplit_dates_not_online = ymd(readRDS(paste0(path_dropbox, "hms_hysplit/hysplit_dates_not_online.rds")))
hysplit_dates_gis_corrupt = ymd(readRDS(paste0(path_dropbox, "hms_hysplit/hysplit_dates_gis_corrupt.rds")))
hysplit_dates_oddly_empty = ymd(readRDS(paste0(path_dropbox, "hms_hysplit/hysplit_dates_oddly_empty.rds")))
...
smoke_dates_empty_data = ymd(readRDS(paste0(path_dropbox, "smoke/smoke_dates_empty_data.rds")))
smoke_dates_repaired_geometry = ymd(readRDS(paste0(path_dropbox, "smoke/smoke_dates_repaired_geometry.rds")))
...
# Save
export_graph(g, file_name = paste0(path_figures, "hms_missing_dates.pdf"), file_type = "pdf")
