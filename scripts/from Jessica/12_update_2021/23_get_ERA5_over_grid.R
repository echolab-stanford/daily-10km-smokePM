...
#-------------------------------------------------------------------------------
year_months = paste0("2021_", str_pad(1:12, 2, "left", 0))
...
get_over_grid <- function(dataset, variable, statistic, time_zone, year_months = NULL, path_era5 = file.path(path_dropbox, "ERA5")) {
  # Confirm dataset
  ...
  file_names <- list.files(path_in, full.names = TRUE, pattern = paste0(year_months, "\\.nc$", collapse = "|"))
...
get_over_grid("global", "boundary_layer_height", "daily_mean", "UTC-06:00", year_months)
get_over_grid("global", "boundary_layer_height", "daily_minimum", "UTC-06:00", year_months)
get_over_grid("global", "boundary_layer_height", "daily_maximum", "UTC-06:00", year_months)
get_over_grid("global", "mean_sea_level_pressure", "daily_mean", "UTC-06:00", year_months)
get_over_grid("land", "2m_temperature", "daily_mean", "UTC-06:00", year_months)
get_over_grid("land", "2m_dewpoint_temperature", "daily_mean", "UTC-06:00", year_months)
get_over_grid("land", "10m_u_component_of_wind", "daily_mean", "UTC-06:00", year_months)
get_over_grid("land", "10m_v_component_of_wind", "daily_mean", "UTC-06:00", year_months)
get_over_grid("land", "surface_pressure", "daily_mean", "UTC-06:00", year_months)
get_over_grid("land", "total_precipitation", "daily_maximum", "UTC+00:00", year_months)
# get_over_grid("land", "wind_speed", "daily_mean", "UTC+00:00", year_months)
