...
#   write.table("./smokePM_training_jobs.csv", 
...
txt_progress_file <- paste0("./output/smokePM_xgb_progress_fold", cv_fold_num, 
...
mod_data <- readRDS("./data/smokePM_training.rds") %>% 
...
saveRDS(bayes_opt_params, 
        paste0("./output/smokePM_bayes_opt_params_fold", cv_fold_num, 
               paste0(c("_drop", drop_vars), collapse = "-"),
               ".rds"))
...
xgb.save(mod_gb_final,
         paste0("./output/smokePM_mod_fold", cv_fold_num, 
                paste0(c("_drop", drop_vars), collapse = "-"),
                ".xgb"))

# predict for full data set and save predictions
pred_data <- readRDS("./data/smokePM_training.rds") 
...
saveRDS(preds, 
        paste0("./output/smokePM_pred_fold", cv_fold_num, 
               paste0(c("_drop", drop_vars), collapse = "-"),
               ".rds"))
...
saveRDS(list(variable_importance = var_import, 
        ...
        paste0("./output/smokePM_var_importance_fold", cv_fold_num, 
               paste0(c("_drop", drop_vars), collapse = "-"),
               ".rds"))